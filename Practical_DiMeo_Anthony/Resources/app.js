...
for(var i=0; i<galleryList[i].length; i++){

	var theImage = Ti.UI.createImageView({
		image: "randomGallery/" + galleryList[i],
		height: "25%",
		top: 100
	});
...
var info = [
{id: "Charizard", icon: "Charizard.png", description: "LvL: 90  						Nature: Brave 						Gender: M 						Health: 266  						Attack: 155  						Defense: 165 						Sp.Atk: 220 						Sp.Def: 184 						Speed: 198 						Charizard is a fire/flying type pokemon. Charizard flies around the sky in search of powerful opponents. It breathes fire of such great heat that it melts anything. However, it never turns its fiery breath on any opponent weaker than itself."},
{id: "Lucario",   icon: "Lucario.png",   description: "LvL: 89  						Nature: Jolly						Gender: F 				        Health: 230  						Attack: 150  						Defense: 131  						Sp.Atk: 270,  						Sp.Def: 150  						Speed: 220  						Lucario is a fighting/steel type pokemon. It has the ability to sense the Auras of all things. It understands human speech.. It's said that no foe can remain invisible to Lucario, since it can detect Auras. Even foes it could not otherwise see."},
{id: "Gengar",    icon: "Gengar.png",    description: "LvL: 85  						Nature: Adament  				Gender: F 				        Health: 250  						Attack: 202  						Defense: 160  						Sp.Atk: 211  						Sp.Def: 160   						Speed: 200  						Gengar is a ghost/poison type pokemon. It hides in shadows. It is said that if Gengar is hiding, it cools the area by nearly 10 degrees Fahrenheit.. To steal the life of its target, it slips into the prey's shadow and silently waits for an opportunity."},
{id: "Vulcarona", icon: "Volcarona.png", description: "LvL: 87  						Nature: Rash						Gender: F 				        Health: 300 						Attack: 112  						Defense: 130  						Sp.Atk: 265,  						Sp.Def: 201 						Speed: 191  						Vulcarona is a bug/fire type pokemon. When volcanic ash darkened the atmosphere, it is said that Volcarona's fire provided a replacement for the sun. A sea of fire engulfs the surroundings of their battles, since they use their six wings to scatter their ember scales."},  
...
videoPlayer1.url = "megacharizardHD.mp4";
