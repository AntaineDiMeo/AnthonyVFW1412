...
/**
 The base class for all Practical_DiMeo_Anthony modules
 */
...
/**
 Practical_DiMeo_Anthony Platform calls this method on startup.
 */
-(void)startup;

/**
 Practical_DiMeo_Anthony Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Practical_DiMeo_Anthony Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Practical_DiMeo_Anthony Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Practical_DiMeo_Anthony Platform calls this method on resume.
 @param sender The sender of the event.
 */
