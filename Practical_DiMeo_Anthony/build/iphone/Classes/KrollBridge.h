...
@interface Practical_DiMeo_AnthonyObject : KrollCoverageObject {
#else
@interface Practical_DiMeo_AnthonyObject : KrollObject {
#endif
@private
...
extern NSString * Practical_DiMeo_Anthony$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Practical_DiMeo_AnthonyObject *_practical_dimeo_anthony;
    KrollObject* console;
	BOOL shutdown;
