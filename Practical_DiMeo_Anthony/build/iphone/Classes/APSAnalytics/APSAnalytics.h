 ...
 * to send analytic data that can be viewed on the Practical_DiMeo_Anthony Dashboard.
 *
 * For information on getting started with Practical_DiMeo_Anthony Platform Services,
