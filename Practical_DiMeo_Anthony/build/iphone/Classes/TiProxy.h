...
//Rare exceptions to indicate a bug in the _practical_dimeo_anthony code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Practical_DiMeo_Anthony proxies.
 */
