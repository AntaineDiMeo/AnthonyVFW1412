...
// in simulator we redefine to format for Practical_DiMeo_Anthony Developer console
...
{\
	NSString * exceptionName = [@"org.practical_dimeo_anthony." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practical_dimeo_anthony";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPractical_DiMeo_AnthonyNativeItemNone = -1, 
	UIPractical_DiMeo_AnthonyNativeItemSpinner = -2,
	UIPractical_DiMeo_AnthonyNativeItemProgressBar = -3,
	
	UIPractical_DiMeo_AnthonyNativeItemSlider = -4,
	UIPractical_DiMeo_AnthonyNativeItemSwitch = -5,
	UIPractical_DiMeo_AnthonyNativeItemMultiButton = -6,
	UIPractical_DiMeo_AnthonyNativeItemSegmented = -7,
	
	UIPractical_DiMeo_AnthonyNativeItemTextView = -8,
	UIPractical_DiMeo_AnthonyNativeItemTextField = -9,
	UIPractical_DiMeo_AnthonyNativeItemSearchBar = -10,
	
	UIPractical_DiMeo_AnthonyNativeItemPicker = -11,
	UIPractical_DiMeo_AnthonyNativeItemDatePicker = -12,
	
	UIPractical_DiMeo_AnthonyNativeItemInfoLight = -13,
	UIPractical_DiMeo_AnthonyNativeItemInfoDark = -14,
	
	UIPractical_DiMeo_AnthonyNativeItemDisclosure = -15,
	
	UIPractical_DiMeo_AnthonyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Practical_DiMeo_Anthony instances of
