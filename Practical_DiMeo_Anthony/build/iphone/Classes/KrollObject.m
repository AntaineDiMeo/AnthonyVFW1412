...
//@interface Practical_DiMeo_AnthonyObject : NSObject
//@end

@interface Practical_DiMeo_AnthonyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Practical_DiMeo_AnthonyObject class]])
		{
			for (NSString *key in [[(Practical_DiMeo_AnthonyObject*)o modules] allKeys])
			{
