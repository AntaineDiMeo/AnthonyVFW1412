...
/**
 The base class for all Day1_Installing modules
 */
...
/**
 Day1_Installing Platform calls this method on startup.
 */
-(void)startup;

/**
 Day1_Installing Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Day1_Installing Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Day1_Installing Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Day1_Installing Platform calls this method on resume.
 @param sender The sender of the event.
 */
