...
//@interface Day1_InstallingObject : NSObject
//@end

@interface Day1_InstallingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Day1_InstallingObject class]])
		{
			for (NSString *key in [[(Day1_InstallingObject*)o modules] allKeys])
			{
