...
//Rare exceptions to indicate a bug in the _day1_installing code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Day1_Installing proxies.
 */
