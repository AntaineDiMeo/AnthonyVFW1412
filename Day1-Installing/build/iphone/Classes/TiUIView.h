...
/**
 Base class for all Day1_Installing views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Day1_Installing view hierarchy (such as wrapped iOS UIViews) was touched.
