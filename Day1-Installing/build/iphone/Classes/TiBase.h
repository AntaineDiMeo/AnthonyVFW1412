...
// in simulator we redefine to format for Day1_Installing Developer console
...
{\
	NSString * exceptionName = [@"org.day1_installing." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.day1_installing";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDay1_InstallingNativeItemNone = -1, 
	UIDay1_InstallingNativeItemSpinner = -2,
	UIDay1_InstallingNativeItemProgressBar = -3,
	
	UIDay1_InstallingNativeItemSlider = -4,
	UIDay1_InstallingNativeItemSwitch = -5,
	UIDay1_InstallingNativeItemMultiButton = -6,
	UIDay1_InstallingNativeItemSegmented = -7,
	
	UIDay1_InstallingNativeItemTextView = -8,
	UIDay1_InstallingNativeItemTextField = -9,
	UIDay1_InstallingNativeItemSearchBar = -10,
	
	UIDay1_InstallingNativeItemPicker = -11,
	UIDay1_InstallingNativeItemDatePicker = -12,
	
	UIDay1_InstallingNativeItemInfoLight = -13,
	UIDay1_InstallingNativeItemInfoDark = -14,
	
	UIDay1_InstallingNativeItemDisclosure = -15,
	
	UIDay1_InstallingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Day1_Installing instances of
