...
@interface Day1_InstallingObject : KrollCoverageObject {
#else
@interface Day1_InstallingObject : KrollObject {
#endif
@private
...
extern NSString * Day1_Installing$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Day1_InstallingObject *_day1_installing;
    KrollObject* console;
	BOOL shutdown;
