...
// in simulator we redefine to format for DiMeo_Anthony_Lab2Buildinganinterface Developer console
...
{\
	NSString * exceptionName = [@"org.dimeo_anthony_lab2buildinganinterface." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dimeo_anthony_lab2buildinganinterface";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemNone = -1, 
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSpinner = -2,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemProgressBar = -3,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSlider = -4,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSwitch = -5,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemMultiButton = -6,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSegmented = -7,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemTextView = -8,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemTextField = -9,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSearchBar = -10,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemPicker = -11,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemDatePicker = -12,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemInfoLight = -13,
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemInfoDark = -14,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemDisclosure = -15,
	
	UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DiMeo_Anthony_Lab2Buildinganinterface instances of
