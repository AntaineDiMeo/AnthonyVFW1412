...
MAKE_SYSTEM_PROP(ACTIVITY,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIDiMeo_Anthony_Lab2BuildinganinterfaceNativeItemContactAdd);
