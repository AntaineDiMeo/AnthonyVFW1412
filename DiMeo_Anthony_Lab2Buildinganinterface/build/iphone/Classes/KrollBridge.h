...
@interface DiMeo_Anthony_Lab2BuildinganinterfaceObject : KrollCoverageObject {
#else
@interface DiMeo_Anthony_Lab2BuildinganinterfaceObject : KrollObject {
#endif
@private
...
extern NSString * DiMeo_Anthony_Lab2Buildinganinterface$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DiMeo_Anthony_Lab2BuildinganinterfaceObject *_dimeo_anthony_lab2buildinganinterface;
    KrollObject* console;
	BOOL shutdown;
