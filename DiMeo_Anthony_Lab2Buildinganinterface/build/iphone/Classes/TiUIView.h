...
/**
 Base class for all DiMeo_Anthony_Lab2Buildinganinterface views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DiMeo_Anthony_Lab2Buildinganinterface view hierarchy (such as wrapped iOS UIViews) was touched.
