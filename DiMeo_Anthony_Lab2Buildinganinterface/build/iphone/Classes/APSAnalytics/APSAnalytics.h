 ...
 * to send analytic data that can be viewed on the DiMeo_Anthony_Lab2Buildinganinterface Dashboard.
 *
 * For information on getting started with DiMeo_Anthony_Lab2Buildinganinterface Platform Services,
