...
//@interface DiMeo_Anthony_Lab2BuildinganinterfaceObject : NSObject
//@end

@interface DiMeo_Anthony_Lab2BuildinganinterfaceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DiMeo_Anthony_Lab2BuildinganinterfaceObject class]])
		{
			for (NSString *key in [[(DiMeo_Anthony_Lab2BuildinganinterfaceObject*)o modules] allKeys])
			{
