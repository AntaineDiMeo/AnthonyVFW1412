...
//Rare exceptions to indicate a bug in the _dimeo_anthony_lab2buildinganinterface code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DiMeo_Anthony_Lab2Buildinganinterface proxies.
 */
