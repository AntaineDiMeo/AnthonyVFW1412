...
/**
 The base class for all DiMeo_Anthony_Lab2Buildinganinterface modules
 */
...
/**
 DiMeo_Anthony_Lab2Buildinganinterface Platform calls this method on startup.
 */
-(void)startup;

/**
 DiMeo_Anthony_Lab2Buildinganinterface Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 DiMeo_Anthony_Lab2Buildinganinterface Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 DiMeo_Anthony_Lab2Buildinganinterface Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 DiMeo_Anthony_Lab2Buildinganinterface Platform calls this method on resume.
 @param sender The sender of the event.
 */
