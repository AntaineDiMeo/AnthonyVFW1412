...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.dimeo_anthony_lab2buildinganinterface._dimeo_anthony_lab2buildinganinterface.imageloader" code:1 userInfo:errorDetail];
