...
// in simulator we redefine to format for TakeHome Developer console
...
{\
	NSString * exceptionName = [@"org.takehome." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.takehome";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITakeHomeNativeItemNone = -1, 
	UITakeHomeNativeItemSpinner = -2,
	UITakeHomeNativeItemProgressBar = -3,
	
	UITakeHomeNativeItemSlider = -4,
	UITakeHomeNativeItemSwitch = -5,
	UITakeHomeNativeItemMultiButton = -6,
	UITakeHomeNativeItemSegmented = -7,
	
	UITakeHomeNativeItemTextView = -8,
	UITakeHomeNativeItemTextField = -9,
	UITakeHomeNativeItemSearchBar = -10,
	
	UITakeHomeNativeItemPicker = -11,
	UITakeHomeNativeItemDatePicker = -12,
	
	UITakeHomeNativeItemInfoLight = -13,
	UITakeHomeNativeItemInfoDark = -14,
	
	UITakeHomeNativeItemDisclosure = -15,
	
	UITakeHomeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TakeHome instances of
