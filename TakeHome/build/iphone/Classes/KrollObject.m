...
//@interface TakeHomeObject : NSObject
//@end

@interface TakeHomeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TakeHomeObject class]])
		{
			for (NSString *key in [[(TakeHomeObject*)o modules] allKeys])
			{
