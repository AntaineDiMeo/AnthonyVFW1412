...
// in simulator we redefine to format for Project2_DiMeo_Anthony Developer console
...
{\
	NSString * exceptionName = [@"org.project2_dimeo_anthony." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project2_dimeo_anthony";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProject2_DiMeo_AnthonyNativeItemNone = -1, 
	UIProject2_DiMeo_AnthonyNativeItemSpinner = -2,
	UIProject2_DiMeo_AnthonyNativeItemProgressBar = -3,
	
	UIProject2_DiMeo_AnthonyNativeItemSlider = -4,
	UIProject2_DiMeo_AnthonyNativeItemSwitch = -5,
	UIProject2_DiMeo_AnthonyNativeItemMultiButton = -6,
	UIProject2_DiMeo_AnthonyNativeItemSegmented = -7,
	
	UIProject2_DiMeo_AnthonyNativeItemTextView = -8,
	UIProject2_DiMeo_AnthonyNativeItemTextField = -9,
	UIProject2_DiMeo_AnthonyNativeItemSearchBar = -10,
	
	UIProject2_DiMeo_AnthonyNativeItemPicker = -11,
	UIProject2_DiMeo_AnthonyNativeItemDatePicker = -12,
	
	UIProject2_DiMeo_AnthonyNativeItemInfoLight = -13,
	UIProject2_DiMeo_AnthonyNativeItemInfoDark = -14,
	
	UIProject2_DiMeo_AnthonyNativeItemDisclosure = -15,
	
	UIProject2_DiMeo_AnthonyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Project2_DiMeo_Anthony instances of
