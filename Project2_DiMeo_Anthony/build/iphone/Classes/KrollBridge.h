...
@interface Project2_DiMeo_AnthonyObject : KrollCoverageObject {
#else
@interface Project2_DiMeo_AnthonyObject : KrollObject {
#endif
@private
...
extern NSString * Project2_DiMeo_Anthony$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Project2_DiMeo_AnthonyObject *_project2_dimeo_anthony;
    KrollObject* console;
	BOOL shutdown;
