...
//Rare exceptions to indicate a bug in the _project2_dimeo_anthony code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Project2_DiMeo_Anthony proxies.
 */
