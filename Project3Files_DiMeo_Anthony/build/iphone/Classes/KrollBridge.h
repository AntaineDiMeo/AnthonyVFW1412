...
@interface Project3FilesObject : KrollCoverageObject {
#else
@interface Project3FilesObject : KrollObject {
#endif
@private
...
extern NSString * Project3Files$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Project3FilesObject *_project3files;
    KrollObject* console;
	BOOL shutdown;
