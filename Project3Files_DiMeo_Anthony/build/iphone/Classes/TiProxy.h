...
//Rare exceptions to indicate a bug in the _project3files code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Project3Files proxies.
 */
