...
// in simulator we redefine to format for Project3Files Developer console
...
{\
	NSString * exceptionName = [@"org.project3files." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project3files";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProject3FilesNativeItemNone = -1, 
	UIProject3FilesNativeItemSpinner = -2,
	UIProject3FilesNativeItemProgressBar = -3,
	
	UIProject3FilesNativeItemSlider = -4,
	UIProject3FilesNativeItemSwitch = -5,
	UIProject3FilesNativeItemMultiButton = -6,
	UIProject3FilesNativeItemSegmented = -7,
	
	UIProject3FilesNativeItemTextView = -8,
	UIProject3FilesNativeItemTextField = -9,
	UIProject3FilesNativeItemSearchBar = -10,
	
	UIProject3FilesNativeItemPicker = -11,
	UIProject3FilesNativeItemDatePicker = -12,
	
	UIProject3FilesNativeItemInfoLight = -13,
	UIProject3FilesNativeItemInfoDark = -14,
	
	UIProject3FilesNativeItemDisclosure = -15,
	
	UIProject3FilesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Project3Files instances of
