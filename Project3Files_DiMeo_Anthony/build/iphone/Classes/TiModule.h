...
/**
 The base class for all Project3Files modules
 */
...
/**
 Project3Files Platform calls this method on startup.
 */
-(void)startup;

/**
 Project3Files Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Project3Files Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Project3Files Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Project3Files Platform calls this method on resume.
 @param sender The sender of the event.
 */
