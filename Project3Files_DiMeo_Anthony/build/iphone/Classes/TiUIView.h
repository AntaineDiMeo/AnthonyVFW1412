...
/**
 Base class for all Project3Files views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Project3Files view hierarchy (such as wrapped iOS UIViews) was touched.
