...
//@interface Project3FilesObject : NSObject
//@end

@interface Project3FilesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Project3FilesObject class]])
		{
			for (NSString *key in [[(Project3FilesObject*)o modules] allKeys])
			{
