...
//@interface Project2_DiMeo_AnthonyObject : NSObject
//@end

@interface Project2_DiMeo_AnthonyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Project2_DiMeo_AnthonyObject class]])
		{
			for (NSString *key in [[(Project2_DiMeo_AnthonyObject*)o modules] allKeys])
			{
