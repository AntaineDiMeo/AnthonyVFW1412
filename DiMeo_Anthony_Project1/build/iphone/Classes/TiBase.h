...
// in simulator we redefine to format for DiMeo_Anthony_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.dimeo_anthony_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dimeo_anthony_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDiMeo_Anthony_Project1NativeItemNone = -1, 
	UIDiMeo_Anthony_Project1NativeItemSpinner = -2,
	UIDiMeo_Anthony_Project1NativeItemProgressBar = -3,
	
	UIDiMeo_Anthony_Project1NativeItemSlider = -4,
	UIDiMeo_Anthony_Project1NativeItemSwitch = -5,
	UIDiMeo_Anthony_Project1NativeItemMultiButton = -6,
	UIDiMeo_Anthony_Project1NativeItemSegmented = -7,
	
	UIDiMeo_Anthony_Project1NativeItemTextView = -8,
	UIDiMeo_Anthony_Project1NativeItemTextField = -9,
	UIDiMeo_Anthony_Project1NativeItemSearchBar = -10,
	
	UIDiMeo_Anthony_Project1NativeItemPicker = -11,
	UIDiMeo_Anthony_Project1NativeItemDatePicker = -12,
	
	UIDiMeo_Anthony_Project1NativeItemInfoLight = -13,
	UIDiMeo_Anthony_Project1NativeItemInfoDark = -14,
	
	UIDiMeo_Anthony_Project1NativeItemDisclosure = -15,
	
	UIDiMeo_Anthony_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DiMeo_Anthony_Project1 instances of
