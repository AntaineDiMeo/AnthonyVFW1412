...
//Rare exceptions to indicate a bug in the _dimeo_anthony_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DiMeo_Anthony_Project1 proxies.
 */
