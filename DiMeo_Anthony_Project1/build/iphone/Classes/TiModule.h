...
/**
 The base class for all DiMeo_Anthony_Project1 modules
 */
...
/**
 DiMeo_Anthony_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 DiMeo_Anthony_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 DiMeo_Anthony_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 DiMeo_Anthony_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 DiMeo_Anthony_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
