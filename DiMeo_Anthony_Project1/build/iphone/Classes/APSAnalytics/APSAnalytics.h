 ...
 * to send analytic data that can be viewed on the DiMeo_Anthony_Project1 Dashboard.
 *
 * For information on getting started with DiMeo_Anthony_Project1 Platform Services,
