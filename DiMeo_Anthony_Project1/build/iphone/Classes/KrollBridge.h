...
@interface DiMeo_Anthony_Project1Object : KrollCoverageObject {
#else
@interface DiMeo_Anthony_Project1Object : KrollObject {
#endif
@private
...
extern NSString * DiMeo_Anthony_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DiMeo_Anthony_Project1Object *_dimeo_anthony_project1;
    KrollObject* console;
	BOOL shutdown;
