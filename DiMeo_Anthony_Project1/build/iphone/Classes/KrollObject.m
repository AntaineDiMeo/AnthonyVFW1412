...
//@interface DiMeo_Anthony_Project1Object : NSObject
//@end

@interface DiMeo_Anthony_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DiMeo_Anthony_Project1Object class]])
		{
			for (NSString *key in [[(DiMeo_Anthony_Project1Object*)o modules] allKeys])
			{
