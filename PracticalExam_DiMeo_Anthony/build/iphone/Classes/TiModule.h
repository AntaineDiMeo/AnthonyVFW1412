...
/**
 The base class for all PracticalExam_DiMeo_Anthony modules
 */
...
/**
 PracticalExam_DiMeo_Anthony Platform calls this method on startup.
 */
-(void)startup;

/**
 PracticalExam_DiMeo_Anthony Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PracticalExam_DiMeo_Anthony Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PracticalExam_DiMeo_Anthony Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PracticalExam_DiMeo_Anthony Platform calls this method on resume.
 @param sender The sender of the event.
 */
