...
//Rare exceptions to indicate a bug in the _practicalexam_dimeo_anthony code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PracticalExam_DiMeo_Anthony proxies.
 */
