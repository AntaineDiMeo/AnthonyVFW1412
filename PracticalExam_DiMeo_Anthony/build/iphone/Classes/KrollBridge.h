...
@interface PracticalExam_DiMeo_AnthonyObject : KrollCoverageObject {
#else
@interface PracticalExam_DiMeo_AnthonyObject : KrollObject {
#endif
@private
...
extern NSString * PracticalExam_DiMeo_Anthony$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PracticalExam_DiMeo_AnthonyObject *_practicalexam_dimeo_anthony;
    KrollObject* console;
	BOOL shutdown;
