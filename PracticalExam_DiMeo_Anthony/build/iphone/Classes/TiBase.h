...
// in simulator we redefine to format for PracticalExam_DiMeo_Anthony Developer console
...
{\
	NSString * exceptionName = [@"org.practicalexam_dimeo_anthony." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practicalexam_dimeo_anthony";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPracticalExam_DiMeo_AnthonyNativeItemNone = -1, 
	UIPracticalExam_DiMeo_AnthonyNativeItemSpinner = -2,
	UIPracticalExam_DiMeo_AnthonyNativeItemProgressBar = -3,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemSlider = -4,
	UIPracticalExam_DiMeo_AnthonyNativeItemSwitch = -5,
	UIPracticalExam_DiMeo_AnthonyNativeItemMultiButton = -6,
	UIPracticalExam_DiMeo_AnthonyNativeItemSegmented = -7,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemTextView = -8,
	UIPracticalExam_DiMeo_AnthonyNativeItemTextField = -9,
	UIPracticalExam_DiMeo_AnthonyNativeItemSearchBar = -10,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemPicker = -11,
	UIPracticalExam_DiMeo_AnthonyNativeItemDatePicker = -12,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemInfoLight = -13,
	UIPracticalExam_DiMeo_AnthonyNativeItemInfoDark = -14,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemDisclosure = -15,
	
	UIPracticalExam_DiMeo_AnthonyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PracticalExam_DiMeo_Anthony instances of
