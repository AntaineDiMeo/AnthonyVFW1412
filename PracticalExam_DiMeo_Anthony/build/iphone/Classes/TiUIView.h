...
/**
 Base class for all PracticalExam_DiMeo_Anthony views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PracticalExam_DiMeo_Anthony view hierarchy (such as wrapped iOS UIViews) was touched.
