...
//@interface PracticalExam_DiMeo_AnthonyObject : NSObject
//@end

@interface PracticalExam_DiMeo_AnthonyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PracticalExam_DiMeo_AnthonyObject class]])
		{
			for (NSString *key in [[(PracticalExam_DiMeo_AnthonyObject*)o modules] allKeys])
			{
