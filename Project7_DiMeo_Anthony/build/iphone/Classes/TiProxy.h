...
//Rare exceptions to indicate a bug in the _project7_dimeo_anthony code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Project7_DiMeo_Anthony proxies.
 */
