 ...
 * to send analytic data that can be viewed on the Project7_DiMeo_Anthony Dashboard.
 *
 * For information on getting started with Project7_DiMeo_Anthony Platform Services,
