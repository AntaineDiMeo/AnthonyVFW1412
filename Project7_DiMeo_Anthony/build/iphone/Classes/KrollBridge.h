...
@interface Project7_DiMeo_AnthonyObject : KrollCoverageObject {
#else
@interface Project7_DiMeo_AnthonyObject : KrollObject {
#endif
@private
...
extern NSString * Project7_DiMeo_Anthony$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Project7_DiMeo_AnthonyObject *_project7_dimeo_anthony;
    KrollObject* console;
	BOOL shutdown;
