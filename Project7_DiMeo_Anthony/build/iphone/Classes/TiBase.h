...
// in simulator we redefine to format for Project7_DiMeo_Anthony Developer console
...
{\
	NSString * exceptionName = [@"org.project7_dimeo_anthony." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.project7_dimeo_anthony";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProject7_DiMeo_AnthonyNativeItemNone = -1, 
	UIProject7_DiMeo_AnthonyNativeItemSpinner = -2,
	UIProject7_DiMeo_AnthonyNativeItemProgressBar = -3,
	
	UIProject7_DiMeo_AnthonyNativeItemSlider = -4,
	UIProject7_DiMeo_AnthonyNativeItemSwitch = -5,
	UIProject7_DiMeo_AnthonyNativeItemMultiButton = -6,
	UIProject7_DiMeo_AnthonyNativeItemSegmented = -7,
	
	UIProject7_DiMeo_AnthonyNativeItemTextView = -8,
	UIProject7_DiMeo_AnthonyNativeItemTextField = -9,
	UIProject7_DiMeo_AnthonyNativeItemSearchBar = -10,
	
	UIProject7_DiMeo_AnthonyNativeItemPicker = -11,
	UIProject7_DiMeo_AnthonyNativeItemDatePicker = -12,
	
	UIProject7_DiMeo_AnthonyNativeItemInfoLight = -13,
	UIProject7_DiMeo_AnthonyNativeItemInfoDark = -14,
	
	UIProject7_DiMeo_AnthonyNativeItemDisclosure = -15,
	
	UIProject7_DiMeo_AnthonyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Project7_DiMeo_Anthony instances of
