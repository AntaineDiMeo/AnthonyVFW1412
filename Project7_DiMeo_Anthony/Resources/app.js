...
var secondGallery = Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, "secondGallery");
var galleryListTwo = gallery.getDirectoryListing();
...
for(var i=0; i<itemCount; i++){
	...
	var theImage = Ti.UI.createImageView({image: "imageGallery/" + galleryList[i]});
...
var theSecondImage = Ti.UI.createImageView({image: "secondGallery/" + galleryListTwo[i]});
