...
@interface Takehome2_DiMeo_AnthonyObject : KrollCoverageObject {
#else
@interface Takehome2_DiMeo_AnthonyObject : KrollObject {
#endif
@private
...
extern NSString * Takehome2_DiMeo_Anthony$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Takehome2_DiMeo_AnthonyObject *_takehome2_dimeo_anthony;
    KrollObject* console;
	BOOL shutdown;
