...
// in simulator we redefine to format for Takehome2_DiMeo_Anthony Developer console
...
{\
	NSString * exceptionName = [@"org.takehome2_dimeo_anthony." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.takehome2_dimeo_anthony";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITakehome2_DiMeo_AnthonyNativeItemNone = -1, 
	UITakehome2_DiMeo_AnthonyNativeItemSpinner = -2,
	UITakehome2_DiMeo_AnthonyNativeItemProgressBar = -3,
	
	UITakehome2_DiMeo_AnthonyNativeItemSlider = -4,
	UITakehome2_DiMeo_AnthonyNativeItemSwitch = -5,
	UITakehome2_DiMeo_AnthonyNativeItemMultiButton = -6,
	UITakehome2_DiMeo_AnthonyNativeItemSegmented = -7,
	
	UITakehome2_DiMeo_AnthonyNativeItemTextView = -8,
	UITakehome2_DiMeo_AnthonyNativeItemTextField = -9,
	UITakehome2_DiMeo_AnthonyNativeItemSearchBar = -10,
	
	UITakehome2_DiMeo_AnthonyNativeItemPicker = -11,
	UITakehome2_DiMeo_AnthonyNativeItemDatePicker = -12,
	
	UITakehome2_DiMeo_AnthonyNativeItemInfoLight = -13,
	UITakehome2_DiMeo_AnthonyNativeItemInfoDark = -14,
	
	UITakehome2_DiMeo_AnthonyNativeItemDisclosure = -15,
	
	UITakehome2_DiMeo_AnthonyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Takehome2_DiMeo_Anthony instances of
