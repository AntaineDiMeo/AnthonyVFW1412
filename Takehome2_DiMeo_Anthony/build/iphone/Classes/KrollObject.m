...
//@interface Takehome2_DiMeo_AnthonyObject : NSObject
//@end

@interface Takehome2_DiMeo_AnthonyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Takehome2_DiMeo_AnthonyObject class]])
		{
			for (NSString *key in [[(Takehome2_DiMeo_AnthonyObject*)o modules] allKeys])
			{
