...
//Rare exceptions to indicate a bug in the _takehome2_dimeo_anthony code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Takehome2_DiMeo_Anthony proxies.
 */
