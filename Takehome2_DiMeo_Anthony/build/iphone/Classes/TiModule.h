...
/**
 The base class for all Takehome2_DiMeo_Anthony modules
 */
...
/**
 Takehome2_DiMeo_Anthony Platform calls this method on startup.
 */
-(void)startup;

/**
 Takehome2_DiMeo_Anthony Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Takehome2_DiMeo_Anthony Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Takehome2_DiMeo_Anthony Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Takehome2_DiMeo_Anthony Platform calls this method on resume.
 @param sender The sender of the event.
 */
