...
// in simulator we redefine to format for views Developer console
...
{\
	NSString * exceptionName = [@"org.views." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.views";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIviewsNativeItemNone = -1, 
	UIviewsNativeItemSpinner = -2,
	UIviewsNativeItemProgressBar = -3,
	
	UIviewsNativeItemSlider = -4,
	UIviewsNativeItemSwitch = -5,
	UIviewsNativeItemMultiButton = -6,
	UIviewsNativeItemSegmented = -7,
	
	UIviewsNativeItemTextView = -8,
	UIviewsNativeItemTextField = -9,
	UIviewsNativeItemSearchBar = -10,
	
	UIviewsNativeItemPicker = -11,
	UIviewsNativeItemDatePicker = -12,
	
	UIviewsNativeItemInfoLight = -13,
	UIviewsNativeItemInfoDark = -14,
	
	UIviewsNativeItemDisclosure = -15,
	
	UIviewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all views instances of
