...
//@interface DiMeo_Anthony_Project2part1Object : NSObject
//@end

@interface DiMeo_Anthony_Project2part1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DiMeo_Anthony_Project2part1Object class]])
		{
			for (NSString *key in [[(DiMeo_Anthony_Project2part1Object*)o modules] allKeys])
			{
