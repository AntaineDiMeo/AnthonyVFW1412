...
// in simulator we redefine to format for DiMeo_Anthony_Project2part1 Developer console
...
{\
	NSString * exceptionName = [@"org.dimeo_anthony_project2part1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dimeo_anthony_project2part1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDiMeo_Anthony_Project2part1NativeItemNone = -1, 
	UIDiMeo_Anthony_Project2part1NativeItemSpinner = -2,
	UIDiMeo_Anthony_Project2part1NativeItemProgressBar = -3,
	
	UIDiMeo_Anthony_Project2part1NativeItemSlider = -4,
	UIDiMeo_Anthony_Project2part1NativeItemSwitch = -5,
	UIDiMeo_Anthony_Project2part1NativeItemMultiButton = -6,
	UIDiMeo_Anthony_Project2part1NativeItemSegmented = -7,
	
	UIDiMeo_Anthony_Project2part1NativeItemTextView = -8,
	UIDiMeo_Anthony_Project2part1NativeItemTextField = -9,
	UIDiMeo_Anthony_Project2part1NativeItemSearchBar = -10,
	
	UIDiMeo_Anthony_Project2part1NativeItemPicker = -11,
	UIDiMeo_Anthony_Project2part1NativeItemDatePicker = -12,
	
	UIDiMeo_Anthony_Project2part1NativeItemInfoLight = -13,
	UIDiMeo_Anthony_Project2part1NativeItemInfoDark = -14,
	
	UIDiMeo_Anthony_Project2part1NativeItemDisclosure = -15,
	
	UIDiMeo_Anthony_Project2part1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DiMeo_Anthony_Project2part1 instances of
