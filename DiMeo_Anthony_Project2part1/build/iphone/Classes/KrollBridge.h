...
@interface DiMeo_Anthony_Project2part1Object : KrollCoverageObject {
#else
@interface DiMeo_Anthony_Project2part1Object : KrollObject {
#endif
@private
...
extern NSString * DiMeo_Anthony_Project2part1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DiMeo_Anthony_Project2part1Object *_dimeo_anthony_project2part1;
    KrollObject* console;
	BOOL shutdown;
